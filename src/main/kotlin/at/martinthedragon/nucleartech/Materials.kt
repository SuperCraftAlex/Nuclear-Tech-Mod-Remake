...
object Materials {
    ...
    val actinium227 = add(MG(ingot = I.actiniumIngot, nugget = I.actinium227Nugget, powder = I.actiniumPowder, billet = I.actinium227Billet))
    ...
    val americium241 = add(MG(ingot = I.americium241Ingot, nugget = I.americium241Nugget, billet = I.americium241Billet))
    val americium242 = add(MG(ingot = I.americium242Ingot, nugget = I.americium242Nugget, billet = I.americium242Billet))
    val americiumFuel = add(MG(ingot = I.americiumFuelIngot, nugget = I.americiumFuelNugget, billet = I.americiumFuelBillet))
    ...
    val australium = add(MG(ore = BI.australianOre, deepOre = BI.deepslateAustralianOre, block = BI.australiumBlock, raw = I.rawAustralium, ingot = I.australiumIngot, nugget = I.australiumNugget, powder = I.australiumPowder, billet = I.australiumBillet))
    val bakelite = add(MG(ingot = I.bakeliteIngot))
    val beryllium = add(MG(ore = BI.berylliumOre, deepOre = BI.deepslateBerylliumOre, block = BI.berylliumBlock, raw = I.rawBeryllium, ingot = I.berylliumIngot, nugget = I.berylliumNugget, crystals = I.berylliumCrystals, powder = I.berylliumPowder, billet = I.berylliumBillet))
    val bismuth = add(MG(ingot = I.bismuthIngot, nugget = I.bismuthNugget, billet = I.bismuthBillet))
    val boron = add(MG(ingot = I.boronIngot))
    val cobalt = add(MG(ore = BI.cobaltOre, deepOre = BI.deepslateCobaltOre, block = BI.cobaltBlock, raw = I.rawCobalt, ingot = I.cobaltIngot, nugget = I.cobaltNugget, crystals = I.cobaltCrystals, powder = I.cobaltPowder, billet = I.cobaltBillet))
    val cobalt60 = add(MG(ingot = I.cobalt60Ingot, nugget = I.cobalt60Nugget, billet = I.cobalt60Billet))
    ...
    val ghiorsium336 = add(MG(ingot = I.ghiorsium336Ingot, nugget = I.ghiorsium336Nugget, billet = I.ghiorsium336Billet))
    val gold198 = add(MG(ingot = I.gold198Ingot, nugget = I.gold198Nugget, billet = I.gold198Billet))
    val graphite = add(MG(ingot = I.graphiteIngot))
    val hesFuel = add(MG(ingot = I.highEnrichedSchrabidiumFuelIngot, nugget = I.highEnrichedSchrabidiumFuelNugget, billet = I.highEnrichedSchrabidiumFuelBillet))
    ...
    val lead209 = add(MG(ingot = I.lead209Ingot, nugget = I.lead209Nugget, billet = I.lead209Billet))
    val lesFuel = add(MG(ingot = I.lowEnrichedSchrabidiumFuelIngot, nugget = I.lowEnrichedSchrabidiumFuelNugget, billet = I.lowEnrichedSchrabidiumFuelBillet))
    ...
    val moxFuel = add(MG(block = BI.moxFuelBlock, ingot = I.moxFuelIngot, nugget = I.moxFuelNugget, billet = I.moxFuelBillet))
    val naturalPlutonium = add(MG(ore = BI.netherPlutoniumOre, block = BI.plutoniumBlock, raw = I.rawPlutonium, ingot = I.plutoniumIngot, nugget = I.plutoniumNugget, crystals = I.plutoniumCrystals, powder = I.plutoniumPowder, billet = I.plutoniumBillet))
    val naturalUranium = add(MG(ore = BI.uraniumOre, deepOre = BI.deepslateUraniumOre, block = BI.uraniumBlock, raw = I.rawUranium, ingot = I.uraniumIngot, nugget = I.uraniumNugget, crystals = I.uraniumCrystals, powder = I.uraniumPowder, billet = I.uraniumBillet))
    val neptunium = add(MG(block = BI.neptuniumBlock, ingot = I.neptuniumIngot, nugget = I.neptuniumNugget, powder = I.neptuniumPowder, billet = I.neptuniumBillet))
    val neptuniumFuel = add(MG(ingot = I.neptuniumFuelIngot, nugget = I.neptuniumFuelNugget, billet = I.neptuniumFuelBillet))
    ...
    val nuclearWaste = add(MG(block = BI.nuclearWasteBlock, ingot = I.nuclearWaste, nugget = I.tinyNuclearWaste, billet = I.nuclearWasteBillet))
    val osmiridium = add(MG(ingot = I.osmiridiumIngot, nugget = I.osmiridiumNugget, crystals = I.osmiridiumCrystals))
    val plutonium238 = add(MG(block = BI.pu238Block, ingot = I.pu238Ingot, nugget = I.pu238Nugget, billet = I.pu238Billet))
    val plutonium239 = add(MG(block = BI.pu239Block, ingot = I.pu239Ingot, nugget = I.pu239Nugget, billet = I.pu239Billet))
    val plutonium240 = add(MG(block = BI.pu240Block, ingot = I.pu240Ingot, nugget = I.pu240Nugget, billet = I.pu240Billet))
    val plutonium241 = add(MG(ingot = I.pu241Ingot, nugget = I.pu241Nugget, billet = I.pu241Billet))
    val plutoniumFuel = add(MG(block = BI.plutoniumFuelBlock, ingot = I.plutoniumFuelIngot, nugget = I.plutoniumFuelNugget, billet = I.plutoniumFuelBillet))
    val polonium = add(MG(ingot = I.polonium210Ingot, nugget = I.poloniumNugget, powder = I.poloniumPowder, billet = I.poloniumBillet))
    val polymer = add(MG(ingot = I.polymerIngot, powder = I.polymerPowder))
    val radium226 = add(MG(ingot = I.radium226Ingot, nugget = I.radium226Nugget, billet = I.radium226Billet))
    val reactorGradeAmericium = add(MG(ingot = I.reactorGradeAmericiumIngot, nugget = I.reactorGradeAmericiumNugget, billet = I.reactorGradeAmericiumBillet))
    val reactorGradePlutonium = add(MG(ingot = I.reactorGradePlutoniumIngot, nugget = I.reactorGradePlutoniumNugget, billet = I.reactorGradePlutoniumBillet))
    ...
    val schrabidium = add(MG(ore = BI.schrabidiumOre, deepOre = BI.deepslateSchrabidiumOre, block = BI.schrabidiumBlock, raw = I.rawSchrabidium, ingot = I.schrabidiumIngot, nugget = I.schrabidiumNugget, crystals = I.schrabidiumCrystals, powder = I.schrabidiumPowder, plate = I.schrabidiumPlate, wire = I.schrabidiumWire, billet = I.schrabidiumBillet))
    val schrabidiumFuel = add(MG(block = BI.schrabidiumFuelBlock, ingot = I.schrabidiumFuelIngot, nugget = I.schrabidiumFuelNugget, billet = I.schrabidiumFuelBillet))
    val schraranium = add(MG(ingot = I.schraraniumIngot, crystals = I.schraraniumCrystals))
    val solinium = add(MG(block = BI.soliniumBlock, ingot = I.soliniumIngot, nugget = I.soliniumNugget, billet = I.soliniumBillet))
    ...
    val strontium90 = add(MG(ingot = I.strontium90Ingot, nugget = I.strontium90Nugget, billet = I.strontium90Billet))
    ...
    val technetium99 = add(MG(ingot = I.technetium99Ingot, nugget = I.technetium99Nugget, billet = I.technetium99Billet))
    val technetiumSteel = add(MG(ingot = I.technetiumSteelIngot))
    val thorium = add(MG(ore = BI.thoriumOre, deepOre = BI.deepslateThoriumOre, block = BI.thoriumBlock, raw = I.rawThorium, ingot = I.th232Ingot, nugget = I.th232Nugget, crystals = I.thoriumCrystals, powder = I.thoriumPowder, billet = I.th232Billet))
    val thoriumFuel = add(MG(block = BI.thoriumFuelBlock, ingot = I.thoriumFuelIngot, nugget = I.thoriumFuelNugget, billet = I.thoriumFuelBillet))
    ...
    val uranium233 = add(MG(block = BI.u233Block, ingot = I.u233Ingot, nugget = I.u233Nugget, billet = I.u233Billet))
    val uranium235 = add(MG(block = BI.u235Block, ingot = I.u235Ingot, nugget = I.u235Nugget, billet = I.u235Billet))
    val uranium238 = add(MG(block = BI.u238Block, ingot = I.u238Ingot, nugget = I.u238Nugget, billet = I.u238Billet))
    val uraniumFuel = add(MG(block = BI.uraniumFuelBlock, ingot = I.uraniumFuelIngot, nugget = I.uraniumFuelNugget, billet = I.uraniumFuelBillet))
...
object TagGroups {
    ...
    val actinium227 = mod(TG(Mat.actinium227, ingot = NT.INGOTS_ACTINIUM, powder = NT.DUSTS_ACTINIUM, billet = NT.BILLETS_ACTINIUM))
    ...
    val australium = mod(TG(Mat.australium, ore = NT.ORES_AUSTRALIUM, block = NT.STORAGE_BLOCKS_AUSTRALIUM, raw = NT.RAW_MATERIALS_AUSTRALIUM, ingot = NT.INGOTS_AUSTRALIUM, nugget = NT.NUGGETS_AUSTRALIUM, powder = NT.DUSTS_AUSTRALIUM, billet = NT.BILLETS_AUSTRALIUM))
    val beryllium = mod(TG(Mat.beryllium, ore = NT.ORES_BERYLLIUM, block = NT.STORAGE_BLOCKS_BERYLLIUM, raw = NT.RAW_MATERIALS_BERYLLIUM, ingot = NT.INGOTS_BERYLLIUM, nugget = NT.NUGGETS_BERYLLIUM, crystals = NT.CRYSTALS_BERYLLIUM, powder = NT.DUSTS_BERYLLIUM, billet = NT.BILLETS_BERYLLIUM))
    val bismuth = mod(TG(Mat.bismuth, ingot = NT.INGOTS_BISMUTH, nugget = NT.NUGGETS_BISMUTH, billet = NT.BILLETS_BISMUTH))
    val cobalt = mod(TG(Mat.cobalt, ore = NT.ORES_COBALT, block = NT.STORAGE_BLOCKS_COBALT, raw = NT.RAW_MATERIALS_COBALT, ingot = NT.INGOTS_COBALT, powder = NT.DUSTS_COBALT, billet = NT.BILLETS_COBALT))
    ...
    val moxFuel = mod(TG(Mat.moxFuel, block = NT.STORAGE_BLOCKS_MOX, ingot = NT.INGOTS_MOX, nugget = NT.NUGGETS_MOX, billet = NT.BILLETS_MOX))
    val naturalPlutonium = mod(TG(Mat.naturalPlutonium, ore = NT.ORES_PLUTONIUM, block = NT.STORAGE_BLOCKS_PLUTONIUM, raw = NT.RAW_MATERIALS_PLUTONIUM, ingot = NT.INGOTS_PLUTONIUM, nugget = NT.NUGGETS_PLUTONIUM, crystals = NT.CRYSTALS_PLUTONIUM, powder = NT.DUSTS_PLUTONIUM, billet = NT.BILLETS_PLUTONIUM))
    val naturalUranium = mod(TG(Mat.naturalUranium, ore = NT.ORES_URANIUM, block = NT.STORAGE_BLOCKS_URANIUM, raw = NT.RAW_MATERIALS_URANIUM, ingot = NT.INGOTS_URANIUM, nugget = NT.NUGGETS_URANIUM, crystals = NT.CRYSTALS_URANIUM, powder = NT.DUSTS_URANIUM, billet = NT.BILLETS_URANIUM))
    val neptunium = mod(TG(Mat.neptunium, block = NT.STORAGE_BLOCKS_NEPTUNIUM, ingot = NT.INGOTS_NEPTUNIUM, nugget = NT.NUGGETS_NEPTUNIUM, powder = NT.DUSTS_NEPTUNIUM, billet = NT.BILLETS_NEPTUNIUM))
    ...
    val nuclearWaste = mod(TG(Mat.nuclearWaste, block = NT.STORAGE_BLOCKS_NUCLEAR_WASTE, billet = NT.BILLETS_NUCLEAR_WASTE))
    val plutoniumFuel = mod(TG(Mat.plutoniumFuel, block = NT.STORAGE_BLOCKS_PLUTONIUM_FUEL, ingot = NT.INGOTS_PLUTONIUM_FUEL, nugget = NT.NUGGETS_PLUTONIUM_FUEL, billet = NT.BILLETS_PLUTONIUM_FUEL))
    val polonium = mod(TG(Mat.polonium, ingot = NT.INGOTS_POLONIUM, nugget = NT.NUGGETS_POLONIUM, powder = NT.DUSTS_POLONIUM, billet = NT.BILLETS_POLONIUM))
    ...
    val schrabidium = mod(TG(Mat.schrabidium, ore = NT.ORES_SCHRABIDIUM, block = NT.STORAGE_BLOCKS_SCHRABIDIUM, raw = NT.RAW_MATERIALS_SCHRABIDIUM, ingot = NT.INGOTS_SCHRABIDIUM, nugget = NT.NUGGETS_SCHRABIDIUM, crystals = NT.CRYSTALS_SCHRABIDIUM, powder = NT.DUSTS_SCHRABIDIUM, plate = NT.PLATES_SCHRABIDIUM, wire = NT.WIRES_SCHRABIDIUM, billet = NT.BILLETS_SCHRABIDIUM))
    val schrabidiumFuel = mod(TG(Mat.schrabidiumFuel, block = NT.STORAGE_BLOCKS_SCHRABIDIUM_FUEL, ingot = NT.INGOTS_SCHRABIDIUM_FUEL, nugget = NT.NUGGETS_SCHRABIDIUM_FUEL, billet = NT.BILLETS_SCHRABIDIUM_FUEL))
    val schraranium = mod(TG(Mat.schraranium, ingot = NT.INGOTS_SCHRARANIUM, crystals = NT.CRYSTALS_SCHRARANIUM))
    val solinium = mod(TG(Mat.solinium, block = NT.STORAGE_BLOCKS_SOLINIUM, ingot = NT.INGOTS_SOLINIUM, nugget = NT.NUGGETS_SOLINIUM, billet = NT.BILLETS_SOLINIUM))
    ...
    val thorium = mod(TG(Mat.thorium, ore = NT.ORES_THORIUM, block = NT.STORAGE_BLOCKS_THORIUM, raw = NT.RAW_MATERIALS_THORIUM, ingot = NT.INGOTS_THORIUM, nugget = NT.NUGGETS_THORIUM, crystals = NT.CRYSTALS_THORIUM, powder = NT.DUSTS_THORIUM, billet = NT.BILLETS_THORIUM))
    val thoriumFuel = mod(TG(Mat.thoriumFuel, block = NT.STORAGE_BLOCKS_THORIUM_FUEL, ingot = NT.INGOTS_THORIUM_FUEL, nugget = NT.NUGGETS_THORIUM_FUEL, billet = NT.BILLETS_THORIUM_FUEL))
    ...
    val uraniumFuel = mod(TG(Mat.uraniumFuel, block = NT.STORAGE_BLOCKS_URANIUM_FUEL, ingot = NT.INGOTS_URANIUM_FUEL, nugget = NT.NUGGETS_URANIUM_FUEL, billet = NT.BILLETS_URANIUM_FUEL))
...
data class VanillaGroup(
    ...
    val billet: Supplier<out Item>? = null,
    ...
    override fun billet() = billet?.get()
}
...
data class TagGroup(
    ...
    fun billetTagAndItem() = billet to materialGroup.billet()
}
