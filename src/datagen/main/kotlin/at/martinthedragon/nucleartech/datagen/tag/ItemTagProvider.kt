...
class ItemTagProvider(
    ...
    private fun copyFromBlocks() = with(NTechTags.Items) {
        ...
        copy(NTechTags.Blocks.ORES_VOLCANIC_GEM, ORES_VOLCANIC_GEM)
        ...
        copy(NTechTags.Blocks.ORES_IN_GROUND_BASALT, ORES_IN_GROUND_BASALT)
    ...
    private fun crystalTags() = with(NTechTags.Items) {
        ...
        tag(Tags.Items.GEMS).addTags(CRYSTALS, GEMS_ALUMINIUM, GEMS_BERYLLIUM, GEMS_COAL, GEMS_COBALT, GEMS_COPPER, GEMS_DIAMOND, GEMS_FLUORITE, GEMS_GOLD, GEMS_IRON, GEMS_LAPIS, GEMS_LEAD, GEMS_LITHIUM, GEMS_NITER, GEMS_PHOSPHORUS, GEMS_PLUTONIUM, GEMS_RARE_EARTH, GEMS_REDSTONE, GEMS_SCHRABIDIUM, GEMS_SCHRARANIUM, GEMS_STARMETAL, GEMS_SULFUR, GEMS_THORIUM, GEMS_TITANIUM, GEMS_TRIXITE, GEMS_TUNGSTEN, GEMS_URANIUM, GEMS_VOLCANIC)
        ...
        tag(GEMS_VOLCANIC).add(NTechItems.volcanicGem)
        return@with
    }
